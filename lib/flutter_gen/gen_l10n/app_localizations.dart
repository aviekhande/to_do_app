...
abstract class AppLocalizations {
  ...
  /// No description provided for @enterYourTask.
  ///
  /// In en, this message translates to:
  /// **'Enter your task'**
  String get enterYourTask;
  ...
  /// No description provided for @makeChangesToYourAcc.
  ///
  /// In en, this message translates to:
  /// **'Make changes to your account'**
  String get makeChangesToYourAcc;
  ...
  /// No description provided for @manageYourPass.
  ///
  /// In en, this message translates to:
  /// **'Manage your password'**
  String get manageYourPass;
  ...
  /// No description provided for @updateAcc.
  ///
  /// In en, this message translates to:
  /// **'Update Account'**
  String get updateAcc;
  ...
  /// No description provided for @sendResetInst.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @imp.
  ///
  /// In en, this message translates to:
  /// **'Important'**
  String get imp;
